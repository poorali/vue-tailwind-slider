<template>
    <div id="app" class="w-full flex flex-col h-full">
        ...
        <div class="flex flex-col md:flex-row justify-start md:justify-around items-center md:items-start">
            <Slider title="Samsung Galaxy S23 Plus 5G" features="Colour: Lavender" class="w-full md:w-5/12 mt-10 h-96 md:h-4/5" thumbnails-orientation="horizontal" :autoplay="true" :autoplay-delay="5000">
                ...
                <SliderImage src="/images/product-image-front.jpeg" thumbnail="/images/product-image-front-thumbnail.jpeg" large-image="/images/product-image-front-large.jpeg" key="image-4"/>
                <SliderImage src="/images/product-image-front.jpeg" thumbnail="/images/product-image-front-thumbnail.jpeg" large-image="/images/product-image-front-large.jpeg" key="image-5"/>
                <SliderImage src="/images/product-image-front.jpeg" thumbnail="/images/product-image-front-thumbnail.jpeg" large-image="/images/product-image-front-large.jpeg" key="image-6"/>
                <SliderImage src="/images/product-image-front.jpeg" thumbnail="/images/product-image-front-thumbnail.jpeg" large-image="/images/product-image-front-large.jpeg" key="image-7"/>
